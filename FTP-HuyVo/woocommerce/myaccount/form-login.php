...
<div class="form-login-wrapper">
	<?php if ('yes' === get_option('woocommerce_enable_myaccount_registration')) : ?>
		...
		<div class="u-columns col2-set" id="customer_login">
			...
			<div class="u-column1 box-account ">
			...
			<form class="woocommerce-form woocommerce-form-login login" method="post" novalidate>
				...
				<p class="form-row">
					...
					<button type="submit" class="woocommerce-button btn-submit woocommerce-form-login__submit<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>" name="login" value="<?php esc_attr_e('Log in', 'woocommerce'); ?>"><?php esc_html_e('Log in', 'woocommerce'); ?></button>
				</p>
			...
			<div class="u-column2 box-account ">
				...
				<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action('woocommerce_register_form_tag'); ?>>
					...
					<p class="woocommerce-form-row form-row">
						...
						<button type="submit" class="woocommerce-Button woocommerce-button btn-submit<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?> woocommerce-form-register__submit" name="register" value="<?php esc_attr_e('Register', 'woocommerce'); ?>"><?php esc_html_e('Register', 'woocommerce'); ?></button>
					</p>
