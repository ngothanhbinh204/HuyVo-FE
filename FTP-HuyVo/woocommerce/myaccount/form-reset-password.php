...
<form method="post" class="woocommerce-ResetPassword lost_reset_password form-woo">
	<div class="form-woo-inner">
		...
		<p class="woocommerce-form-row form-row">
			...
			<button type="submit" class="woocommerce-Button btn-submit<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>" value="<?php esc_attr_e('Save', 'woocommerce'); ?>"><?php esc_html_e('Save', 'woocommerce'); ?></button>
		</p>
